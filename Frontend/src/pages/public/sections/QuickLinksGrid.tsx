...
const QUICK_LINKS = [
  ...
  { title: 'Village Directory & Data', desc: 'Garhi & Model Village Insights', to: '/villages' },
  { title: 'Development Car Philosophy', desc: "Soul's Journey & Blessings", to: '/development-car' },
  { title: 'Philosophy & Teachings', desc: 'Vivekananda & Buddha Guidance', to: '/philosophy' },
    ...
    <div className="bg-white border border-forest-900 mb-2">
      ...
      <div className="divide-y divide-gray-200">
        {QUICK_LINKS.map((link) => (
          ...
          >
            <div className="font-bold text-xs text-forest-900 flex items-center gap-1">
              <span className="text-saffron-600 font-bold">&raquo;</span> {link.title}
            </div>
            <p className="text-[10px] text-gray-700 leading-tight pl-3">
              {link.desc}
            </p>
          </Link>
        ))}
